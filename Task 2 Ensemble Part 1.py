...
accuracy_score(y_test, bag_clf.predict(x_test)) # test - 95%
...
accuracy_score(y_test, ada_clf.predict(x_test)) # 96%

# Evaluation on Training Data
accuracy_score(y_train, ada_clf.predict(x_train)) # 100%
...
accuracy_score(y_test, boost_clf.predict(x_test)) # 96%

accuracy_score(y_train, boost_clf.predict(x_train)) # 100%

# https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.GradientBoostingClassifier.html#sklearn.ensemble.GradientBoostingClassifier

# Hyperparameters - to inprove the accuracy
...
accuracy_score(y_test, boost_clf2.predict(x_test)) # 96%

# Evaluation on Training Data
accuracy_score(y_train, boost_clf2.predict(x_train)) # 99%
...
accuracy_score(y_test, xgb_clf.predict(x_test)) # 97%
...
accuracy_score(y_test, cv_xg_clf.predict(x_test)) # 96%
